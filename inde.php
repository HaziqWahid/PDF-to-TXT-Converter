...
// JAVA JAR EXECUTE
$command = "java -jar out/artifacts/PDFConverter_jar/PDFConverter.jar";
echo shell_exec($command);

//GETTING THE FILE

    $fileRetrievePath = getcwd()."/uploads/retrieveClear/";
    $retrieveFileName = $filename_without_ext."txt";
    $retrieveClearDownload = $fileRetrievePath.$retrieveFileName;
?>
